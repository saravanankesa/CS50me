...
SECRET_KEY = 'django-insecure-e&k%d*v*s@@pb1k_xzp3v=)5c$4mbq&qx-k$c9jlxf_srk6(+#'
...
LOGGING = {
    ...
    'loggers': {
        ...
        __name__: {  # This uses the name of the current module, you can specify 'your_app_name' instead
            'handlers': ['console'],
            'level': 'DEBUG',
            'propagate': False,
        },
